...
#alpha, ridge regresyon icin s??f??r degerini alir.
#lambda 0.05 oran??nda katsayilar guncellensin denir
?glmnet
...
model_cross_valid$nzero #8 beta katsayimiz vardi. yani sifir olan hehrangi bir degi??ken yok
